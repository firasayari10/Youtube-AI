...
export const LikedVideosSection=()=>{
    return(
       <Suspense fallback={<LikedVideosSectionSuspenseSkeleton  />}>
...
const LikedVideosSectionSuspenseSkeleton = () => {
    return (
        <div>
...
const LikedVideosSectionSuspense = ()=>{
    const [videos,query ]= trpc.playlists.getLike.useSuspenseInfiniteQuery(
        {limit:DEFAULT_LIMIT},
        {
