...
export const videos = pgTable("videos",{
    ...
    muxTrackStatus:text("mux_track_sttatus"),
...
export const videoViewRelattions = relations(videoViews , ({one})=>({
    users:one(users,{
...
export const videoViewInserttSchema = createInsertSchema(videoViews);
...
export const videoReactionRelattions = relations(videoReactions , ({one})=>({
    users:one(users,{
...
export const videoReactionInserttSchema = createInsertSchema(videoReactions);
